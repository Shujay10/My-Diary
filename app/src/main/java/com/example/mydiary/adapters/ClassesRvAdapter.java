...
public class ClassesRvAdapter extends RecyclerView.Adapter<ClassesRvAdapter.ExampleHolder>{
    ...
    @NonNull
    @Override
    public ClassesRvAdapter.ExampleHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.classes_recycler,parent,false);

        return new ClassesRvAdapter.ExampleHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ClassesRvAdapter.ExampleHolder holder, int position) {
